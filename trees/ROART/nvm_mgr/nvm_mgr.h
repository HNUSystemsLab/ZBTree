...
class NVMMgr {
  ...
  public:
    ...
    static const int PGSIZE = 512 * 1024;                     // 256K
    static const long long filesize = 160LL * 1024 * PGSIZE; // 40GB

    size_t run_start_addr = 0x50000000;
    size_t run_thread_local_start;
    size_t run_data_block_start;
